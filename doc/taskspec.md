...
It is important to note that in some languages passing by reference does not make a copy, instead passing normally makes a copy. This might affect performances. For example array not passed by reference are copied in pascal and this might slow down solutions. 
